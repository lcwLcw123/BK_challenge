...
if __name__ == "__main__":
    # changelleng dataset:
    dataset_path="./huawei_task/huawei_image"  #Your dataset path
    checkpoint = torch.load("./saved_models/DIS_model.pth")
    result_path="./huawei_task/huawei_image"  #The folder path that you want to save the results
    ...
    with torch.no_grad():
        ...
        for i, im_path in tqdm(enumerate(im_list), total=len(im_list)):
            ...
            io.imsave(os.path.join(result_path,im_name+".mask.png"),result)
